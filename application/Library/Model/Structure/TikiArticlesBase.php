...
* DO NOT EDIT
*/
class Model_Structure_TikiArticlesBase
{
    protected $m_articleId;
    protected $m_topline;
    protected $m_title;
    ...
    protected $m_image_x;
    protected $m_image_y;
    protected $m_list_image_x;
    protected $m_list_image_y;
    ...
    protected $m_rating;
    protected $m_isfloat;
    protected $m_ispublished;
    protected $m_articleId_Orig;
    ...
    public function __construct($arrData = null)
    {
        if (isset($arrData)) {
            ...
            $this->setState('s');
            $this->setIspublished('y');
        }
        return;
    }
    public function TikiArticlesBase($arrData = null)
    {
    ...
    public function getListImageX()
    {
        return $this->m_list_image_x;
    }
    public function setListImageX($value)
    {
        $this->m_list_image_x = $value;
        return;
    }

    public function getListImageY()
    {
        return $this->m_list_image_y;
    }
    public function setListImageY($value)
    {
        $this->m_list_image_y = $value;
        return;
    }
    ...
    {
        $this->m_ispublished = $value;
        return;
    }

    public function getOrigArticleid()
    {
        return $this->m_articleId_Orig;
    }
    public function setOrigArticleid($value)
    {
        if (isset($this->m_articleId_Orig)) { return; }
        $this->m_articleId_Orig = $value;
        return;
    }

    public function loadFromArray($arrValues)
    {
        $this->setArticleid($arrValues['articleId']);
        ...
        $this->setListImageX($arrValues['list_image_x']);
        $this->setListImageY($arrValues['list_image_y']);
        ...
        $this->setIspublished($arrValues['ispublished']);
        return;
    }
        ...
        foreach ($arrValues as $key=>$val) {
            switch ($key) {
                ...
                case 'image_y':
                    ...
                    break;
                case 'list_image_x':
                    $this->setListImageX($val);
                    break;
                case 'list_image_y':
                    $this->setListImageY($val);
                    break;
                case 'image_data':
    ...
    {
        $arrValues = array();
        $arrValues['articleId'] = $this->getArticleid();
        ...
        $arrValues['list_image_x'] = $this->getListImageX();
        $arrValues['list_image_y'] = $this->getListImageY();
        ...
        $arrValues['ispublished'] = $this->getIspublished();
        return $arrValues;
    }
