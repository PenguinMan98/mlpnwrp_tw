...
// $Id: twversion.class.php 45261 2013-03-21 20:00:02Z changi67 $
...
class TWVersion
{
	...
	function TWVersion()
	{
		...
		$this->version 	= '10.2';	// Never ever put any spaces in this value.  This will appear in tiki-admin.php?page=general
		$this->star	= 'Sun';
		$this->releases	= array();
